...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1 class="text-center">My job is not done with jenkins  sbd-sbd ipl/ipo</h1>
      <h2 class="text-center">Welcome to T shreya on behalf of DevOps Academy</h2>
      <h3 class="text-center">  shreya  </h2>
